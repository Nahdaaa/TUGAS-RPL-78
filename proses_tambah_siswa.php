...
if($_POST){
    ...
    if(empty($nama_siswa)){
        ...
        include "koneksi.php";
        $insert=mysqli_query($conn,"insert into siswa (nama_siswa,tanggal_lahir, alamat, gender, username, password, id_kelas) 
        value ('".$nama_siswa."','".$tanggal_lahir."','".$alamat."','".$gender."','".$username."','".md5($password)."','".$id_kelas."')") 
